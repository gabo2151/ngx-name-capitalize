...
[![Angular compatibility](https://github.com/gabo2151/ngx-name-capitalize/actions/workflows/ci.yml/badge.svg?branch=v1)](https://github.com/gabo2151/ngx-name-capitalize/actions/workflows/ci.yml?query=branch%3Av1)
...
**Complete and deliberately frozen, not abandoned.** This line exists to serve Angular 12
and 13, and that set will never grow — Angular 14 and above are served by `2.x` and `3.x`.
So a quiet commit history here is the design, not neglect.
...
against the newest `name-capitalize` 1.x. The badge above is that job; it links to the
runs themselves.

<!-- compat:begin -->
Verified against Angular **12 and 13** — every major this line supports.
...
If you are on Angular 14 or later, move up a line — you get the same fixes plus the
standalone pipe.
